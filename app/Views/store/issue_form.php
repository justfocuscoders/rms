...
<div class="page-header mb-3 border-bottom pb-2 d-flex justify-content-between align-items-center">
  ...
  <a href="<?= base_url('storeissue') ?>" class="btn btn-sm btn-outline-secondary">
    <i class="bx bx-arrow-back"></i> Back
  </a>
</div>

<form action="<?= base_url('storeissue/saveIssue') ?>" method="post" class="card shadow-sm p-4">
  ...
  <div class="text-end mt-3">
    ...
    <a href="<?= base_url('storeissue') ?>" class="btn btn-secondary">Cancel</a>
  </div>
</form>
